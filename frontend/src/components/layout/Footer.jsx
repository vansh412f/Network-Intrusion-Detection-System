  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-4 sm:flex-row sm:px-6">
        ...
        {/* Right side = Built by Vansh text + GitHub button */}
        <div className="flex items-center gap-4">
          <span style={{ fontSize: '11px', color: 'var(--color-text-muted)' }}>
            Built by Vansh
          </span>
          <motion.a
            href="https://github.com/vansh412f/Network-Intrusion-Detection-System"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 rounded-lg border px-2.5 py-1 text-xs transition-colors duration-150"
            style={{
              borderColor:     'var(--color-border-card)',
              backgroundColor: 'var(--color-bg-card)',
